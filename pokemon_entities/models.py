...
class Pokemon(models.Model):
    ...
    en_title = models.CharField(max_length=200, blank=True, verbose_name='Название англ.')
    jp_title = models.CharField(max_length=200, blank=True, verbose_name='Название яп.')
...
class PokemonEntity(models.Model):
    ...
    deffence = models.IntegerField(null=True, blank=True, verbose_name='Оборона')
